...
//            TI의 BIOS를 사용하지 않았을 때 내부 RAM에서 구동하는 예제의 Linker Command File
//			  TI의 SDK v1.20에서 DSP2833x_Headers_nonBIOS.cmd와 28335_RAM_lnk.cmd를 가지고 수정함
//
// [ 사용한 개발 환경 ]
...
/* F28335 Device가 CSM Lock이 걸린 경우 RAML_CODE, RAML_DATA 영역이 Secured 영역이 되므로 사용자께서는 Lock을 풀어주시길 바랍니다 */
 
SECTIONS
{
	/* Setup for "boot to SARAM" mode:                                                                            */ 
	/* The codestart section (found in DSP28_CodeStartBranch.asm) re-directs execution to the start of user code. */
	
	/* Allocate program areas */
	codestart         : > BEGIN,       PAGE = 0
	ramfuncs          : > RAML_CODE,   PAGE = 0  
	.text             : > RAML_CODE,   PAGE = 0
	.cinit            : > RAML_CODE,   PAGE = 0
	.pinit            : > RAML_CODE,   PAGE = 0
	...
	/* Initalized sections */
	.econst           : > RAML_CODE,   PAGE = 0
	.switch           : > RAML_CODE,   PAGE = 0
	
	/* Allocate IQ math areas */
	IQmath            : > RAML_CODE,   PAGE = 0
