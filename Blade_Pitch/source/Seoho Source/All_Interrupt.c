...
//			Position_Control();
		...
		else if( Main_counter & 0x16 ) 	// 16*CC Routines : 1000 
		{	
//				Theta_ref= Final_reference*4.*PI;
				Position_Control();
		}	
...
*/
	Flag.ETC.bit.AUTO_TUNING= Flag_AT;	
...
{
	static Uint16 adata1=0, bdata1=0, cdata1=0, ddata1=0, edata1=0;
	static Uint16 adata2=0, bdata2=0, cdata2=0, ddata2=0, edata2=0;
	static Uint16 fdata1=0;
	static Uint16 fdata2=0;
	static int i=0;
